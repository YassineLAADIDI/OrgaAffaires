...
class Application(tk.Tk):
    ...
    def show_details(self):
        ...
        # Crée une nouvelle fenêtre pour afficher les détails
        detail_window = tk.Toplevel(self)
        detail_window.title("Détails de l'entité")
        
        # Affiche les détails dans un label
    ...
    def modify_node(self):
        ...
        def save_changes():
            old_code = orga.entite.code  # Stocke l'ancien code
        ...
        # Centre la fenêtre de modification par rapport à la fenêtre principale
